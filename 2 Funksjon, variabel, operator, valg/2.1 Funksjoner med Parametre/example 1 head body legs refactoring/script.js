// esercizio 121k
// we have 12 functions in total to select head, body, legs. maybe something can be redone. maybe a refactoring of some sort. hmmm.
...
function selectHead(headNumber, leftHead, rightHead) {
    document.getElementById('head').innerHTML = /*HTML*/`
        <button onclick="selectHead${leftHead}()">◀</button>
        <img src="img/head${headNumber}.png" />
        <button onclick="selectHead${rightHead}()">▶</button>
    `;
}

function selectBody(bodyNumber, leftBody, rightBody) {
    document.getElementById('body').innerHTML = /*HTML*/`
        <button onclick="selectBody${leftBody}()">◀</button>
        <img src="img/body${bodyNumber}.png" />
        <button onclick="selectBody${rightBody}()">▶</button>
    `;
}

function selectLegs(legsNumber, leftLegs, rightLegs) {
    document.getElementById('legs').innerHTML = /*HTML*/`
        <button onclick="selectLegs${leftLegs}()">◀</button>
        <img src="img/legs${legsNumber}.png" />
        <button onclick="selectLegs${rightLegs}()">▶</button>
    `;
}
